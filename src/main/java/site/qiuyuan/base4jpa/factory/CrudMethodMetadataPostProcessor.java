package site.qiuyuan.base4jpa.factory;
...
class CrudMethodMetadataPostProcessor implements RepositoryProxyPostProcessor, BeanClassLoaderAware {
    ...
    private static class DefaultCrudMethodMetadata implements CrudMethodMetadata {
        ...
        /*
         * (non-Javadoc)
         * @see CrudMethodMetadata#getLockModeType()
         */
        @Nullable
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see CrudMethodMetadata#getQueryHints()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see CrudMethodMetadata#getEntityGraph()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see CrudMethodMetadata#getMethod()
         */
        @Override
